...
echo ""
echo "  Admin credentials will be auto-generated."
echo "  You can change the admin username if desired."
echo ""
...
section "Step 8: Starting Keycloak"
if docker compose version &> /dev/null; then
...
for i in $(seq 1 18); do
    if curl -sf --max-time 5 http://127.0.0.1:8180/health/ready &>/dev/null; then
...
echo "  ╠══════════════════════════════════════════════════════╣"
echo "  ║  🔐  Keycloak:                                     ║"
echo "  ║      👉  http://$SERVER_IP:8180"
echo "  ║                                                      ║"
echo "  ║  ⚙️   Admin Console:                               ║"
echo "  ║      👉  http://$SERVER_IP:8180/admin"
echo "  ║                                                      ║"
