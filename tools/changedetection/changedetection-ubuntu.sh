#!/bin/bash
# ============================================================
#   ChangeDetection.io Auto-Installer
...
echo ""
echo "  ╔══════════════════════════════════════════════════╗"
echo "  ║     ChangeDetection.io Auto-Installer           ║"
...
section "Step 7: Starting ChangeDetection.io"
MAX_RETRIES=3
...
info "Waiting for ChangeDetection.io on port 5000..."
HEALTH_OK=0
...
[ "$HEALTH_OK" -eq 0 ] && warn "Not responding. Check: docker logs changedetection"
...
echo "  ║              ✅  Setup Complete!                     ║"
echo "  ╠══════════════════════════════════════════════════════╣"
echo "  ║  👁️  ChangeDetection.io:                           ║"
echo "  ║      👉  http://$SERVER_IP:5000"
echo "  ║                                                      ║"
echo "  ║  🔑  No login required by default.                 ║"
echo "  ║      Add URLs to monitor from the web UI.          ║"
echo "  ║                                                      ║"
echo "  ║  ⚠️  FOR DEMO / TESTING PURPOSES ONLY ⚠️            ║"
echo "  ║       Made by: Mohammed Ali Elshikh                 ║"
echo "  ║       prismatechwork.com                            ║"
