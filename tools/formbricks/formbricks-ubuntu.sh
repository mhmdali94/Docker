...
echo ""
echo "  ╔══════════════════════════════════════════════════╗"
echo "  ║     Formbricks Auto-Installer                   ║"
...
services:
  formbricks:
    ...
    ports:
      - "3001:3000"
    environment:
      DATABASE_URL: postgresql://formbricks:${DB_PASS}@formbricks-postgres:5432/formbricks
      NEXTAUTH_SECRET: ${NEXTAUTH_SECRET}
      NEXTAUTH_URL: http://${SERVER_ADDR}:3001
...
section "Step 8: Starting Formbricks"
if docker compose version &> /dev/null; then
...
echo "  ╠══════════════════════════════════════════════════════╣"
echo "  ║  📋  Formbricks:                                   ║"
echo "  ║      👉  http://$SERVER_ADDR:3001"
echo "  ║                                                      ║"
echo "  ║  📝  First visit: create your account               ║"
echo "  ║                                                      ║"
echo "  ║  ⚠️  FOR DEMO / TESTING PURPOSES ONLY ⚠️            ║"
echo "  ║       Made by: Mohammed Ali Elshikh                 ║"
echo "  ║       prismatechwork.com                            ║"
