...
section "Step 8: Starting Snipe-IT"
if docker compose version &> /dev/null; then
...
info "Waiting for Snipe-IT to be ready..."
for i in $(seq 1 18); do
    if curl -sf --max-time 5 http://127.0.0.1:8002 &>/dev/null; then
        info "Snipe-IT is ready. ✅"
        break
    fi
...
echo "  ╠══════════════════════════════════════════════════════╣"
echo "  ║  🖥️   Snipe-IT:                                    ║"
echo "  ║      👉  http://$SERVER_ADDR:8002"
echo "  ║                                                      ║"
echo "  ║  📝  First visit: complete the setup wizard         ║"
echo "  ║                                                      ║"
echo "  ║  ⚠️  FOR DEMO / TESTING PURPOSES ONLY ⚠️            ║"
echo "  ║       Made by: Mohammed Ali Elshikh                 ║"
echo "  ║       prismatechwork.com                            ║"
